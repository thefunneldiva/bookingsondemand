function updateLinkTag() {
    ...
    if (locationID) {
        ...
        if (existingLink) {
            ...
            existingLink.href = 'https://raw.githubusercontent.com/thefunneldiva/bookingsondemand/main/' + locationID + '.css';
        } else {
            ...
            link.rel = 'stylesheet';
            link.type = 'text/css';
            link.href = 'https://raw.githubusercontent.com/thefunneldiva/bookingsondemand/main/' + locationID + '.css';
